...
class Test_ExerciseOne(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            check_name(
                "Roger-Nigel Hendrich Tuluz Fonfor Fancy-Name Lu Xi Yo"
            ),
            "OK",
        )
    ...
    def test_capitals(self):
        self.assertEqual(
            check_name("hector jubilantes"), "Did you mean Hector Jubilantes?"
        )
        self.assertEqual(
...
class Test_ExerciseTwo(unittest.TestCase):
    ...
    def test_invalid(self):
        ...
        self.assertEqual(
            check_password("B", ("{&*@$!@|KL", 72590, "apple")), "Invalid pair"
        )
        self.assertEqual(
            check_password("B", ["#$.,><><", "66230"]), "Invalid pair"
        )
    ...
    def test_correct(self):
        ...
        self.assertEqual(
            check_password("B", ("#$*@!>\\|PO", "88898")), "Connection OK"
        )
        self.assertEqual(
            check_password("B", ('".<)()??ZZ', 54102)), "Connection OK"
        )
    ...
    def test_long(self):
        ...
        self.assertEqual(
            check_password("A", "M!?"), "Password length incorrect"
        )
    ...
    def test_key(self):
        self.assertEqual(
            check_password("B", ("0?!@&&{}LP", 88104)), "Incorrect key"
        )
        self.assertEqual(
            check_password("B", ("%$@@~`**Lz", 10020)), "Incorrect key"
        )
        self.assertEqual(
            check_password("B", ("^%??~!!;.MA", 96520.0)), "Incorrect key"
        )

    def test_value(self):
        self.assertEqual(
            check_password("B", ("%@^!#@><II", 9898)), "Incorrect value"
        )
        self.assertEqual(
            check_password("B", ("%@^!#@><II", 89359283)), "Incorrect value"
        )
        self.assertEqual(
            check_password("B", ("%@^!#@><II", "apple")), "Incorrect value"
        )
